...
import { ReservationCustomerDetail } from "../../../content/EditPopup";
...
const CHMenuPage = () => {
    ...
    return (
        ...
        <div className="bg-blue-100 grid gap-3 grid-cols-[100px_1fr] md:grid-cols-[175px_1fr] lg:grid-cols-[250px_1fr]">
            <CHSidebar email={email !== null ? email : "null"} name={fname !== null ? fname : "null"} selectedPage={1}></CHSidebar>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 ">
                            {
                                filteredData.length > 0 ? 
                                    filteredData.map((menu) => (
                                        <CHMenuItem data={menu} usedTo={"CHCheckDetail"}></CHMenuItem>
                                    ))
                                    : <div>...</div>
                            }
                        </div>
