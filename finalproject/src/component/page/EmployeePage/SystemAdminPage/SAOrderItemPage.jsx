...
import { OrderItemTable } from "../../../content/DataTable";

const SAOrderItemPage = ({}) => {
    ...
    const Fetchdata = async () => {
        try {
            const response = await axios.get("http://localhost:3001/api/order/"+orderId+"/orderitem");
            ...
            <div className="bg-white rounded-lg pb-4 p-4 shadow h-[100vh]">
                    { !isLoading ? 
                            ...
                            <div className="flex flex-wrap px-4 space-x-5 items-center">
                                ...
                                <label className="text-2xl font-semibold px-5">Order {orderId}</label>
                                ...
                                value={searchColumn} onChange={(e) => {setSearchColumn(e.target.value); setSearchValue("");} }>
                                    ...
                                    <option value="priceperitem">Price Per Item</option>
                            ...
                            <div className="flex-grow">
                                <OrderItemTable data={filteredData} />
                            </div>
...
export default SAOrderItemPage;