        ...
        <div className="bg-blue-100 grid gap-3 grid-cols-[250px_1fr] ">
            ...
            <div className="bg-white rounded-lg pb-4 p-4 shadow h-[100vh]">
                    { !isLoading ? 
                            ...
                            <Link to={'/systemadmin/ingredient'}>
                            ...
                            <div className="flex-grow">
                                <IngredientStockTable data={data} stockData={filteredData} role={role} fetchdata={Fetchdata} setAlert={setAlert} setAlertMessage={setAlertMessage} email={email}/>
                            </div>
...
export default SAIngredientStockPage;