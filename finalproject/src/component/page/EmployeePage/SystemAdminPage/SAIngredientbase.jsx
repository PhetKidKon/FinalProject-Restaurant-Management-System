            ...
            <div className="bg-white rounded-lg pb-4 p-4 shadow h-[100vh]">
                    { !isLoading ? 
                            ...
                            <div className="flex-grow">
                                <IngredientbaseStockTable data={data} stockdata={filteredData} fetchdata={Fetchdata} setAlert={setAlert} setAlertMessage={setAlertMessage}role={"systemadmin"} email={email} ingr={ingredientData}/>
                            </div>
...
export default SAIngredientbase;