...
import { TransactionTable } from "../../../content/DataTable";

const SATransactionPage = ({}) => {
    ...
    return (
        <div className="bg-blue-100 grid gap-3 grid-cols-[250px_1fr] ">
            <SASidebar email={email !== null ? email : "null"} name={fname !== null ? fname : "null"} selectedPage={5}></SASidebar>
                    ...
                    { !isLoading ? 
                            ...
                            <div className="flex flex-wrap px-4 space-x-5 items-center">
                                ...
                                { showPopup && createPortal(
                                    <CreateAccount trigger={showPopup} setTrigger={setShowPopup} fetchData={Fetchdata} setAlert={setAlert} setAlertMessage={setAlertMessage}>
                            ...
                            <div className="flex-grow">
                                <TransactionTable data={filteredData}  fetchdata={Fetchdata} setAlert={setAlert} setAlertMessage={setAlertMessage}/>
                            </div>
...
export default SATransactionPage;