...
import { OrderTable } from "../../../content/DataTable";
                    ...
                    { !isLoading ? 
                            ...
                            <div className="flex flex-wrap px-4 space-x-5 items-center">
                                ...
                                value={searchColumn} onChange={(e) => {setSearchColumn(e.target.value); setSearchValue("");} }>
                                    ...
                                    <option value="reserve_id">Reserve ID</option>
                                    <option value="customer_role">Customer Role</option>
                                    <option value="status">Status</option>
                                    <option value="cashier_email">Cashier Email</option>
                                </select>
                                {   searchColumn != "all" ?
                            ...
                            <div className="flex-grow">
                                <OrderTable data={filteredData}  fetchdata={Fetchdata} setAlert={setAlert} setAlertMessage={setAlertMessage} />
                            </div>
