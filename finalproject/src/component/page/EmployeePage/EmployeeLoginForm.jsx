...
const EmployeeLoginForm = () => {
    ...
    const loginhandle = async (e) => {
        ...
        try {
            const res = await axios.post(`http://localhost:3001/api/accounts/signin/employee`, {
                    email,
                    password
                }, {
                    headers: {
            ...
            switch (role) {
                case 'ROLE_SYSTEMADMIN':
                  navigate('/systemadmin/account');
                  break;
                case 'ROLE_INVENTORYSUPERVISOR':
    ...
    return (
        <AuthPage>
            ...
            <h1 className="text-xl font-bold leading-tight tracking-tight mb-10">Employee : Sign in</h1>
