...
import { CreateIngredient } from "../../../content/EditPopup";
            ...
            <div className="bg-white rounded-lg pb-4 p-4 shadow h-[100vh]">
                    { !isLoading ? 
                            ...
                            <div className="flex flex-wrap px-4 space-x-5 items-center">
                                ...
                                <label className="text-2xl font-semibold px-5 invisible md:visible">Ingredient</label>
                                ...
                                { showPopup && createPortal(
                                    <CreateIngredient trigger={showPopup} setTrigger={setShowPopup} fetchData={Fetchdata} data={data} setAlert={setAlert} email={email} setAlertMessage={setAlertMessage}>
                                    </CreateIngredient>, document.body
                                    )
                                }
                            ...
                            <div className="flex-grow">
                                <IngredientTable data={filteredData}  fetchdata={Fetchdata} setAlert={setAlert} setAlertMessage={setAlertMessage} role={"InventorySupervisor"}/>
                            </div>
...
export default ISIngredientPage;