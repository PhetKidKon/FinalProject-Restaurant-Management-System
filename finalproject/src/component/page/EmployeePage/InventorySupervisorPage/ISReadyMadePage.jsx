...
const ISReadyMadeMenu = ({}) => {
    ...
    const parsedMenuId = menuId ? parseInt(menuId, 10) : null;
            ...
            <div className="bg-white rounded-lg pb-4 p-4 shadow h-[100vh]">
                    { !isLoading ? 
                            ...
                            <div className="flex-grow">
                                <ReadyMadeMenuStockTable data={data} stockdata={filteredData} fetchdata={Fetchdata} setAlert={setAlert} setAlertMessage={setAlertMessage} email={email}/>
                            </div>
                        </div> : <div className="">isLoading</div>
                    }
            </div>
            { showPopup && createPortal(
                <AddStock trigger={showPopup} setTrigger={setShowPopup} fetchData={Fetchdata} data={data} product_type={"readymademenu"} product_id={parsedMenuId} setAlert={setAlert} email={email} setAlertMessage={setAlertMessage}>
...
export default ISReadyMadeMenu;