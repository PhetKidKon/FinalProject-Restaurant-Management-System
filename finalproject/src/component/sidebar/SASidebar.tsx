...
export const SASidebar = ( {email, name, selectedPage} : {email: string, name: string, selectedPage: number} ) => {
    ...
    return (
        <div className="flex flex-col h-screen p-2 space-y-4">
            ...
            <li className="flex flex-col space-y-4 list-none">
                <Link to={'/systemadmin/account'}><Route selected={selectedPage == 1 ? true : false} title="Account"></Route></Link>
                <Link to={'/systemadmin/table'}><Route selected={selectedPage == 2 ? true : false} title="Table"></Route></Link>
                <Link to={'/systemadmin/ingredient'}><Route selected={selectedPage == 3 ? true : false} title="Ingredient"></Route></Link>
                <Link to={'/systemadmin/menu'}><Route selected={selectedPage == 4 ? true : false} title="Menu"></Route></Link>
                <Link to={'/systemadmin/transaction'}><Route selected={selectedPage == 5 ? true : false} title="Transaction"></Route></Link>
                <Link to={'/systemadmin/reservation'}><Route selected={selectedPage == 6 ? true : false} title="Reservation"></Route></Link>
                <Link to={'/systemadmin/order'}><Route selected={selectedPage == 7 ? true : false} title="Order"></Route></Link>
                <Link to={'/systemadmin/bill'}><Route selected={selectedPage == 8 ? true : false} title="Bill"></Route></Link>
            </li>
            </div>
