...
export const CHSidebar = ( {email, name, selectedPage} : {email: string, name: string, selectedPage: number} ) => {
    ...
    return (
        <div className="flex flex-col h-screen p-2 space-y-4">
            ...
            <li className="flex flex-col space-y-4 list-none">
                <Link to='/cashier/menu'><Route selected={selectedPage == 1 ? true : false} title="Menu"></Route></Link>
                <Link to='/cashier/table'><Route selected={selectedPage == 2 ? true : false} title="Table"></Route></Link>
                <Link to='/cashier/reservation'><Route selected={selectedPage == 3 ? true : false} title="Reservation"></Route></Link>
                <Link to='/cashier/order'><Route selected={selectedPage == 4 ? true : false} title="Order"></Route></Link>
                <Link to='/cashier/bill'><Route selected={selectedPage == 5 ? true : false} title="Bill"></Route></Link>
                <Link to='/cashier/history'><Route selected={selectedPage == 6 ? true : false} title="BillHistory"></Route></Link>
            </li>
            </div>
